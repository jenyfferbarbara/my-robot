...
.controller('getServiceCtrl', function ($scope, $filter, $http) {
	...
	function get_results_bear(user, date) {
		...
		url = "http://localhost:8080/api/bears?_id.user=" + user + "&_id.date=" + date
	...
	function get_results_rafa_cr7(user, date) {
		...
		url = "http://localhost:8080/api/rafa_cr7?_id.user=" + user + "&_id.date=" + date
		$http.get(url).then(function (response) {
	...
	function get_results_sinais_consistentes(user, date) {
		...
		url = "http://localhost:8080/api/sinais_consistentes?_id.user=" + user + "&_id.date=" + date
		$http.get(url).then(function (response) {
	...
	function get_results_slum_signals(user, date) {
		...
		url = "http://localhost:8080/api/slum_signals?_id.user=" + user + "&_id.date=" + date
		$http.get(url).then(function (response) {
